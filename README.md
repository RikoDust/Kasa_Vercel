# 📌 Projet KASA – Adaptation déploiement


## 🧾 Description

Ce projet est une adaptation du projet Kasa afin de permettre son déploiement sur la plateforme Vercel.
...
Projet déployé via Vercel après ajustements du build.
